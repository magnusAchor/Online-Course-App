...
def show_exam_result(request, course_id, submission_id):
    ...
    total_score = 0
    grade = 0
    question_results = []  # List to store question correctness
    ...
    passed = grade >= total_score * 0.8  # Assuming 80% pass threshold
    context = {
        'course': course,
        'grade': grade,
        ...
        'question_results': question_results,  # Pass question results
    }
